...
$fatpacked{"Local/Test.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'LOCAL_TEST';
  package Local::Test;
  ...
  sub steps {
      return (qw/Step1 Step2 Step3 Step4 Step5 Step6 Step7/)
  }
  
  1;
LOCAL_TEST

$fatpacked{"Term/Spinner/Color.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'TERM_SPINNER_COLOR';
